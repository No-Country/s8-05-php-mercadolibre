    ...
    <div>
      ...
      <div className="bg-darkBlue text-white">
        <div className="container px-5 py-12 mx-auto">
          <h1 className="sm:text-xl text-lg font-semibold title-font text-center mb-10">Confirme su compra</h1>
          <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
            ...
            <div className="p-4 md:w-1/3 w-full flex flex-col">
              ...
              <div className="flex ">
                <span className="ml-auto">3x $ 55,000.00</span>
              </div>
              <div className="flex ">
                <span className="ml-auto">Banco Nacion ***1447</span>
              </div>
            </div>
            <div className="p-4 md:w-1/3 w-full flex flex-col">
              <div className="flex border-t border-white py-2 ">
