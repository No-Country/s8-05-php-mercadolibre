    ...
    <form>
      <div className="grid grid-cols-1 gap-2 mt-4 sm:grid-cols-2">
        <div>
          ...
          <TextInput id="email1" placeholder="Iphone" required type="text" />
        </div>
        <div id="select">
          <div>
        ...
        <div>
          ...
          <TextInput id="longitud" placeholder="0" required type="number" />
        </div>

        <div>
          <Label htmlFor="ancho" value="Ancho (mm)" />

          <TextInput id="ancho" placeholder="0" required type="number" />
        </div>

        <div>
          <Label htmlFor="alto" value="Alto (mm)" />

          <TextInput id="alto" placeholder="0" required type="number" />
        </div>
        <div>
          <Label htmlFor="price" value="Precio $ AR" />

          <TextInput id="price" placeholder="0" required type="text" />
        </div>
      </div>
      <div id="textarea">
        <div className="mt-4">
        ...
        <Textarea id="description" placeholder="Descripción del producto" required rows={4} />
      </div>
    </form>
  );
}
